...
Phase2ChooseCoord.prototype._generateMoves = function(cases) {
  for (var i = 0; i < 70; ++i) {
    var choose = cases[i];
    for (var move = 0; move < 10; ++move) {
      // TODO: apply the move and record the result.
    }
  }
};
...
function moveYCornerChoose(choose, move) {
  // NOTE: this code was generated by translating Go code to JavaScript.
  // This does some permutations which are equivalent to moveYCornerPerm. By
  // making this an entirely different function, we are helping the JS engine by
