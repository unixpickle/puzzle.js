(function() {
  ...
  function centerHeuristic(state) {
    return allCenterHeuristic[encodeCenters(state)];
  }
  ...
  function makeCenterHeuristic() {
    var res = {};
    var nodes = [{state: solvedSkewb(), depth: 0}];
    var moves = allMoves();
  ...
  function solve(state) {
    for (var i = 0; i < 11; ++i) {
      ...
      if (solution !== null) {
        var Move;
        if ('undefined' !== typeof window) {
          Move = window.puzzlejs.skewb.Move;
        } else if ('function' === typeof require) {
